...
//   const regions = ["All", ...new Set(salespersons.map(person => person.region))];

//   // Calculate statistics
//   const stats = {
//     total: salespersons.length,
//     active: salespersons.filter(p => p.status === "Active").length,
//     totalSales: salespersons.reduce((sum, person) => sum + person.totalSales, 0),
//     totalCommission: salespersons.reduce((sum, person) => sum + person.commission, 0)
//   };
...
//       {/* Header */}
//       <div className="mb-6">
//         <h1 className="text-2xl sm:text-3xl font-bold text-white mb-2">All Salespersons</h1>
//         <p className="text-gray-400">Manage and view all sales team members</p>
//       </div>

//       {/* Statistics Cards */}
//       <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
//         <div className="bg-gray-800 p-4 sm:p-6 rounded-xl border border-gray-700">
//           <h3 className="text-sm sm:text-base font-semibold text-gray-300">Total Salespersons</h3>
//           <p className="text-2xl sm:text-4xl font-bold text-white mt-1 sm:mt-2">{stats.total}</p>
//         </div>
//         <div className="bg-gray-800 p-4 sm:p-6 rounded-xl border border-gray-700">
//           <h3 className="text-sm sm:text-base font-semibold text-gray-300">Active</h3>
//           <p className="text-2xl sm:text-4xl font-bold text-white mt-1 sm:mt-2">{stats.active}</p>
//         </div>
//         <div className="bg-gray-800 p-4 sm:p-6 rounded-xl border border-gray-700">
//           <h3 className="text-sm sm:text-base font-semibold text-gray-300">Total Sales</h3>
//           <p className="text-2xl sm:text-4xl font-bold text-white mt-1 sm:mt-2">{formatCurrency(stats.totalSales)}</p>
//         </div>
//         <div className="bg-gray-800 p-4 sm:p-6 rounded-xl border border-gray-700">
//           <h3 className="text-sm sm:text-base font-semibold text-gray-300">Total Commission</h3>
//           <p className="text-2xl sm:text-4xl font-bold text-white mt-1 sm:mt-2">{formatCurrency(stats.totalCommission)}</p>
//         </div>
//       </div>
...
//                 <tr key={person.id} className="hover:bg-gray-750 transition-colors duration-200">
//                   <td className="px-4 py-4 whitespace-nowrap">
//                     <div className="flex items-center">
//                       <div className="text-2xl mr-3">{person.avatar}</div>
//                       <div>
//                         <div className="text-sm font-medium text-white">{person.name}</div>
//                         <div className="text-sm text-gray-400">ID: {person.id}</div>
//                       </div>
//                     </div>
//                   </td>
//                   <td className="px-4 py-4 whitespace-nowrap">
...
//             Showing <span className="font-medium text-white">{sortedSalespersons.length}</span> of{' '}
//             <span className="font-medium text-white">{salespersons.length}</span> salespersons
//           </p>
//         </div>
//       </div>
//     </div>
...
const SalespersonProfile = ({ salesperson, onClose }) => {
  ...
  const quotationData = {
    ...
    pending: 5,
    recentQuotations: [
      { id: 1, client: "ABC Corp", value: 15000, status: "Won", date: "2024-01-15" },
      { id: 2, client: "XYZ Ltd", value: 8500, status: "Pending", date: "2024-01-14" },
      { id: 3, client: "Global Inc", value: 22000, status: "Accepted", date: "2024-01-12" },
      { id: 4, client: "Tech Solutions", value: 12500, status: "Rejected", date: "2024-01-10" },
    ]
  };
      ...
      <div className="bg-gray-800 rounded-2xl border border-gray-700 w-full max-w-4xl my-8 max-h-[90vh] overflow-hidden">
        ...
        <div className="p-6 border-b border-gray-700 flex justify-between items-center sticky top-0 bg-gray-800 z-10">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-2xl font-bold text-white">{salesperson.name}</h2>
              ...
              <div className="bg-gray-900/50 rounded-xl p-6 border border-gray-700">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-white font-medium">{salesperson.email}</p>
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-400 mb-1">
                      Contact Number
                    </label>
                    <p className="text-white font-medium">{salesperson.phone}</p>
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-400 mb-1">
                      Region
                  ...
                  <div>
                    ...
                    <p className="text-white font-medium">{formatDate(salesperson.joinDate)}</p>
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-400 mb-1">
                      Status
                  ...
                  <div className="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-2xl font-bold text-red-400">{quotationData.rejected}</p>
                      </div>
                  ...
                  <div className="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-2xl font-bold text-blue-400">{quotationData.accepted}</p>
                      </div>
                      <div className="text-2xl">✓</div>
                    </div>
                  </div>
                  <div className="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-2xl font-bold text-green-400">{quotationData.won}</p>
                      </div>
                      <div className="text-2xl">🏆</div>
                    </div>
                  </div>
                  <div className="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-2xl font-bold text-yellow-400">{quotationData.pending}</p>
                      </div>
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
                    <div>
                      ...
                      <p className="text-xl font-bold text-white">{formatCurrency(salesperson.totalSales)}</p>
                    </div>
                    <div className="text-2xl">💰</div>
                  </div>
                  {/* <div className="flex justify-between items-center">
                  ...
                  <div className="flex justify-between items-center">
                    <div>
                      ...
                      <p className="text-xl font-bold text-white">
                        {((quotationData.won / (quotationData.rejected + quotationData.accepted + quotationData.won + quotationData.pending)) * 100).toFixed(1)}%
                      </p>
                    </div>
                    <div className="text-2xl">📈</div>
                  </div>
              ...
              <div className="bg-gray-900/50 rounded-xl p-6 border border-gray-700">
                ...
                <div className="space-y-3">
                  {quotationData.recentQuotations.map((quote) => (
                    <div key={quote.id} className="flex items-center justify-between p-3 bg-gray-800/50 rounded-lg">
                      <div>
                        <p className="font-medium text-white">{quote.client}</p>
                        <p className="text-sm text-gray-400">{formatDate(quote.date)}</p>
                      </div>
                      <div className="text-right">
                        <p className="font-bold text-white">{formatCurrency(quote.value)}</p>
                        <span className={`text-xs px-2 py-1 rounded-full ${
                          quote.status === 'Won' ? 'bg-green-900 text-green-200' :
                          quote.status === 'Accepted' ? 'bg-blue-900 text-blue-200' :
                          quote.status === 'Pending' ? 'bg-yellow-900 text-yellow-200' :
                          'bg-red-900 text-red-200'
                        }`}>
                          {quote.status}
                        </span>
