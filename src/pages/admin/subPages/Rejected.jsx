...
//               <p className="text-red-400 text-xs sm:text-sm mt-1">Not approved</p>
//             </div>
//             <div className="bg-gray-800 rounded-xl p-4 sm:p-6 border border-gray-700">
...
//                               <p className="text-gray-300 text-sm mt-1">{quote.reason}</p>
//                             </div>
//                           </div>
//                         </td>
//                       </tr>
...
//                         <td className="px-4 py-3 text-gray-300 text-sm max-w-xs">{quote.reason}</td>
//                       </tr>
//                     </React.Fragment>
//                   ))}
//                 </tbody>
