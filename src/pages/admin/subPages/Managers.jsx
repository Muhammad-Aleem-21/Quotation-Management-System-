...
// import { FiSearch, FiX, FiUser, FiMail, FiPhone, FiBriefcase, FiUsers, FiFileText, FiCheckCircle, FiXCircle } from 'react-icons/fi';
...
//               <p className="text-gray-400 text-sm sm:text-base">Total Managers</p>
//               <h2 className="text-2xl sm:text-3xl font-bold text-white mt-1 sm:mt-2">{managers.length}</h2>
//               <p className="text-purple-400 text-xs sm:text-sm mt-1">Active managers</p>
//             </div>
//             <div className="bg-gray-800 rounded-xl p-4 sm:p-6 border border-gray-700">
...
//               </h2>
//               <p className="text-blue-400 text-xs sm:text-sm mt-1">Team members</p>
//             </div>
//             <div className="bg-gray-800 rounded-xl p-4 sm:p-6 border border-gray-700">
//               <p className="text-gray-400 text-sm sm:text-base">Active Managers</p>
//               <h2 className="text-2xl sm:text-3xl font-bold text-white mt-1 sm:mt-2">
...
//                   Found {filteredManagers.length} result{filteredManagers.length !== 1 ? 's' : ''} for "{searchQuery}"
//                 </span>
//                 <button
//                   onClick={clearSearch}
...
//                   <tr>
//                     <th className="px-4 py-3 text-left font-semibold text-gray-300 text-sm">Manager ID</th>
//                     <th className="px-4 py-3 text-left font-semibold text-gray-300 text-sm">Name</th>
//                     <th className="px-4 py-3 text-left font-semibold text-gray-300 text-sm">Contact</th>
//                     <th className="px-4 py-3 text-left font-semibold text-gray-300 text-sm">Department</th>
//                     <th className="px-4 py-3 text-left font-semibold text-gray-300 text-sm">Role</th>
//                     <th className="px-4 py-3 text-left font-semibold text-gray-300 text-sm">Team Size</th>
...
//                               </div>
//                               <span className={`px-3 py-1 rounded-full text-xs font-medium border ${getStatusColor(manager.status)}`}>
//                                 {manager.status}
//                               </span>
//                             </div>
...
//                                   <p className="text-blue-300 text-sm truncate">{manager.email}</p>
//                                 </div>
//                               </div>
//                               <div>
...
//                                 <p className="font-bold text-white text-sm">{manager.teamSize} members</p>
//                               </div>
//                             </div>
...
//                           </div>
//                         </td>
//                         <td className="px-4 py-3 text-orange-300 text-sm">{manager.department}</td>
//                         <td className="px-4 py-3 text-gray-300 text-sm">{manager.role}</td>
//                         <td className="px-4 py-3">
//                           <div className="flex items-center gap-2">
//                             <FiUsers className="text-yellow-300" />
//                             <span className="font-bold text-white text-sm">{manager.teamSize}</span>
//                           </div>
//                         </td>
//                         <td className="px-4 py-3">
//                           <span className={`px-3 py-1 rounded-full text-xs font-medium border ${getStatusColor(manager.status)}`}>
