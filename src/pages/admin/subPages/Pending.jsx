...
// import { FiSearch, FiX, FiFileText, FiUser, FiClock, FiAlertCircle } from 'react-icons/fi';
...
//     return pendingQuotations.filter(quote =>
...
//               <h2 className="text-2xl sm:text-3xl font-bold text-white mt-1 sm:mt-2">
//                 ${pendingQuotations.reduce((sum, q) => sum + parseFloat(q.amount.replace('$', '').replace(',', '')), 0).toLocaleString()}
//               </h2>
...
//                               </div>
//                               <span className={`px-3 py-1 rounded-full text-xs font-medium border ${getPriorityColor(quote.priority)} flex items-center gap-1`}>
...
//                         <td className="px-4 py-3">
//                           <span className={`px-3 py-1 rounded-full text-xs font-medium border ${getPriorityColor(quote.priority)} flex items-center gap-1 w-fit`}>
//                             <FiAlertCircle className="text-xs" />
//                             {quote.priority.charAt(0).toUpperCase() + quote.priority.slice(1)}
//                           </span>
//                         </td>
