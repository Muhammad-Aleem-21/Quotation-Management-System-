    ...
    <div className="p-4 sm:p-6 bg-gray-900 min-h-screen text-white">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        <div>
          ...
          <p className="text-gray-400 mt-1">Monitor and manage all team quotation requests</p>
        </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
        <div className="bg-gray-800 rounded-xl p-4 sm:p-6 border border-gray-700">
          ...
          <h2 className="text-2xl sm:text-4xl font-bold text-white mt-1 sm:mt-2">{teamQuotations.length}</h2>
        </div>
        <div className="bg-gray-800 rounded-xl p-4 sm:p-6 border border-gray-700">
        ...
        <div className="bg-gray-800 rounded-xl p-4 sm:p-6 border border-gray-700">
          ...
          <h2 className="text-2xl sm:text-4xl font-bold text-white mt-1 sm:mt-2">$27.5K</h2>
        </div>
      </div>
            ...
            <tbody className="divide-y divide-gray-700">
              {teamQuotations.map((quote) => (
                <tr key={quote.id} className="hover:bg-gray-750 transition-colors duration-200">
                  ...
                  <td className="px-4 py-3">
                    <div className="font-semibold text-white">{quote.salesperson}</div>
                  </td>
                  <td className="px-4 py-3">
