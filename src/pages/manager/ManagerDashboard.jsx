...
const ManagerDashboard = () => {
  ...
  const recentActivities = [
    { action: "New quotation submitted", user: "Sarah M.", time: "30 mins ago", type: "quotation" },
    { action: "Quotation approved", user: "John D.", time: "2 hours ago", type: "approval" },
    { action: "Team meeting scheduled", user: "System", time: "4 hours ago", type: "meeting" },
    { action: "Performance review completed", user: "Mike R.", time: "1 day ago", type: "review" }
  ];
  ...
  return (
    <div className="p-4 sm:p-6 bg-gray-900 min-h-screen text-white">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-400 mt-1">Overview of your team's performance and activities</p>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-4 sm:mb-6">
        ...
        >
          <div className="flex justify-between items-center">
            <div>
              <h2 className="text-gray-400 text-sm sm:text-base">Active Members</h2>
          ...
          <p className="text-gray-500 text-xs mt-2">Click to view →</p> {/* Add this line */}
        </div>
        ...
        >
          <div className="flex justify-between items-center">
            <div>
              <h2 className="text-gray-400 text-sm sm:text-base">Active Quotations</h2>
        ...
        >
          <div className="flex justify-between items-center">
            <div>
              <h2 className="text-gray-400 text-sm sm:text-base">Team Revenue</h2>
        ...
        {/* <div className="bg-gradient-to-br from-green-500/20 to-emerald-500/20 p-4 sm:p-6 rounded-xl border border-green-500/30">
          <div className="flex justify-between items-center">
            <div>
              ...
              <h2 className="text-2xl sm:text-4xl font-bold text-white mt-1 sm:mt-2">{teamStats.acceptedQuotations}</h2>
              <p className="text-green-400 text-xs sm:text-sm mt-1">
                {((teamStats.acceptedQuotations / teamStats.activeQuotations) * 100).toFixed(1)}% of active
              </p>
            </div>
        ...
        {/* <div className="bg-gradient-to-br from-red-500/20 to-rose-500/20 p-4 sm:p-6 rounded-xl border border-red-500/30">
          <div className="flex justify-between items-center">
            <div>
              ...
              <h2 className="text-2xl sm:text-4xl font-bold text-white mt-1 sm:mt-2">{teamStats.rejectedQuotations}</h2>
              <p className="text-red-400 text-xs sm:text-sm mt-1">
                {((teamStats.rejectedQuotations / teamStats.activeQuotations) * 100).toFixed(1)}% of active
              </p>
            </div>
  ...
  <div className="bg-gray-800 p-4 sm:p-6 rounded-xl border border-gray-700">
    <h2 className="text-lg sm:text-xl font-semibold mb-4">Team Performance Trend</h2>
    <div className="h-64 sm:h-72 min-h-[300px]"> {/* Added min-height here */}
      <ResponsiveContainer width="100%" height="100%" minWidth={0}> {/* Added minWidth={0} */}
  ...
  <div className="bg-gray-800 p-4 sm:p-6 rounded-xl border border-gray-700">
    <h2 className="text-lg sm:text-xl font-semibold mb-4">Team Member Performance</h2>
    <div className="h-64 sm:h-72 min-h-[300px]"> {/* Added min-height here */}
      <ResponsiveContainer width="100%" height="100%" minWidth={0}> {/* Added minWidth={0} */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-4 sm:p-6">
          <h2 className="text-lg sm:text-xl font-semibold mb-4">Recent Team Activities</h2>
          <div className="space-y-3">
            {recentActivities.map((activity, index) => (
              <div key={index} className="flex items-center justify-between p-3 bg-gray-750 rounded-lg">
                <div className="flex items-center gap-3">
                  <div className={`w-2 h-2 rounded-full ${
                    activity.type === 'quotation' ? 'bg-blue-400' :
                    activity.type === 'approval' ? 'bg-green-400' :
                    activity.type === 'meeting' ? 'bg-purple-400' : 'bg-yellow-400'
                  }`}></div>
                  <div>
