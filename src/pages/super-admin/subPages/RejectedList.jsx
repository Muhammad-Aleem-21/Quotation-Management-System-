        ...
        <div className={`p-4 sm:p-6 lg:pt-0 ${sidebarOpen ? "overflow-hidden" : ""}`}>
          ...
          <div className="p-4 sm:p-6">
            ...
            <div className="mb-6 flex justify-between items-start">
              {/* Left Text */}
              <div>
                <h1 className="text-2xl sm:text-3xl font-bold text-red-500">Rejected Quotations</h1>
                <p className="text-gray-400 mt-1">
                  Quotations that were not approved. Review reasons and feedback.
                </p>
              </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            <div className="bg-gray-800 rounded-xl p-4 sm:p-6 border border-gray-700">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-red-500 mt-1 sm:mt-2">{rejectedQuotations.length}</h2>
              <p className="text-red-400 text-xs sm:text-sm mt-1 flex items-center gap-1"><FiXCircle /> Declined</p>
            </div>
            <div className="bg-gray-800 rounded-xl p-4 sm:p-6 border border-gray-700">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-white mt-1 sm:mt-2">
                {rejectedQuotations.filter(q => (q.priority || "").toLowerCase() === 'high').length}
              </h2>
              <p className="text-red-400 text-xs sm:text-sm mt-1">Attention needed</p>
            </div>
            <div className="bg-gray-800 rounded-xl p-4 sm:p-6 border border-gray-700">
              ...
              <p className="text-purple-400 text-xs sm:text-sm mt-1">Rejected amount</p>
            </div>
            <div className="bg-gray-800 rounded-xl p-4 sm:p-6 border border-gray-700">
              <p className="text-gray-400 text-sm sm:text-base">Avg. Rejection</p>
              <h2 className="text-2xl sm:text-3xl font-bold text-white mt-1 sm:mt-2">N/A</h2>
              <p className="text-blue-400 text-xs sm:text-sm mt-1">Trend analysis</p>
            </div>
          </div>
          ...
          <div className="bg-gray-800 rounded-lg sm:rounded-xl border border-gray-700 p-4 mb-6">
            <div className="flex flex-col gap-4">
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Search rejected quotations by customer, ID, service, or salesperson..."
                  value={searchQuery}
                  ...
                  {filteredQuotations.map((quote) => (
                    <React.Fragment key={quote.id}>
                      ...
                      <tr className="hidden sm:table-row hover:bg-gray-750 transition-colors duration-200">
                        ...
                        <td className="px-4 py-3">
                          <span className="px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider bg-red-500/10 text-red-500 border border-red-500/20 w-fit flex items-center gap-1">
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-2 sm:p-4 bg-black/70 backdrop-blur-sm">
            <div className="bg-gray-800 border border-gray-700 rounded-2xl w-full max-w-4xl max-h-[95vh] sm:max-h-[90vh] overflow-hidden shadow-2xl animate-in fade-in zoom-in duration-200 flex flex-col">
              ...
              <div className="p-4 sm:p-6 flex-1 overflow-y-auto custom-scrollbar">
                ...
                {/* Rejection Feedback */}
                <div className="mt-6">
                    <h4 className="text-[10px] sm:text-xs uppercase font-bold text-gray-500 tracking-wider">Rejection Feedback</h4>
                    <div className="bg-red-500/5 p-4 rounded-xl border border-red-500/20 mt-3">
                        <p className="text-sm text-red-400 italic">"{selectedQuotation.rejection_reason || 'No specific reason provided.'}"</p>
                    </div>
                </div>
