...
//       case "Manager": return "bg-green-500/20 text-green-300";
//       case "Salesperson": return "bg-purple-500/20 text-purple-300";
...
//         <button className="bg-red-600 hover:bg-red-700 px-4 sm:px-6 py-2 sm:py-3 rounded-xl font-semibold text-white flex gap-2 items-center transition-colors duration-200">
...
//           <h2 className="text-2xl sm:text-4xl font-bold text-white mt-1 sm:mt-2">{users.length}</h2>
//         </div>
//         <div className="bg-gray-800 rounded-xl p-4 sm:p-6 border border-gray-700">
...
//         {/* Sales Team Card */}
//         <div 
//           onClick={() => handleCardClick('sales-team')}
