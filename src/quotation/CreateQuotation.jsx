...
// const coreTypes = {
//   'General cables': ['Single/Core', '2/Core Flat', '3/Core Round', '4/Core Round'],
//   'Flexible Cables BS 6500 IEC 60228': ['Single/Core', '2/Core Round', '3/Core Round', '4/Core Round'],
//   'ALUMINIUM CABLES': ['Single/Core', '2/C', '3/C', '3.5/C', '4/C'],
//   'POWER CABLES': ['Single/Core PVC', 'S/C PVC/PVC', '3/C PVC/PVC', '3.5/C PVC/PVC', '4/C PVC/PVC'],
//   'ALUMINIUM CABLES Armoured': ['Single/Core AL/PVC/AWA', '2/C PVC/SWA/PVC', '3/C PVC/SWA/PVC', '3.5/C PVC/SWA/PVC', '4/C PVC/SWA/PVC'],
//   'POWER CABLES Armoured': ['Single/Core PVC', 'S/C PVC/AWA/PVC', '3/C PVC/SWA/PVC', '3.5/C PVC/SWA/PVC', '4/C PVC/SWA/PVC']
// };
...
//     } else if (field === 'subCategory' || field === 'cableType' || field === 'cableDescription' || field === 'cableSize') {
//       newData.price = 0;
//       newData.finalPrice = 0;
//     }
...
//     let basePrice = 0;
//     const { cableCategory, subCategory, cableType, cableDescription, cableSize, quantity } = formData;

//     switch(cableCategory) {
//       case 'Imperial Sizes BS-2004':
//       case 'Co-axial Cables(RG-Type)':
//       case 'Telephone & Intercom Cables':
//         const cable = cableData[cableCategory].find(item => item.name === cableDescription);
//         basePrice = cable ? cable.price : 0;
//         break;

//       case 'DC Solar Flexible Photovoltic UV-Resistant Cable':
//         if (!cableDescription || !cableType) return 0;
//         const solarCable = cableData[cableCategory].cables.find(item => item.name === cableDescription);
//         if (solarCable) {
...
//       case 'General cables':
//         if (!cableDescription || !cableType) return 0;
//         const generalCable = cableData[cableCategory].find(item => item.description === cableDescription);
//         if (generalCable) {
...
//         if (!cableDescription || !cableType) return 0;
//         const flexibleCable = cableData[cableCategory].find(item => item.description === cableDescription);
//         if (flexibleCable) {
//           if (cableType === 'Single/Core') {
...
//         if (!cableSize || !cableType || !subCategory) return 0;
//         const alumList = subCategory === 'UN-ARMOURED CABLES' 
...
//       case 'POWER CABLES':
//         if (!cableSize || !cableType || !subCategory) return 0;
//         const powerList = subCategory === 'UN-ARMOURED CABLES' 
//           ? cableData[cableCategory].unarmoured 
//           : cableData[cableCategory].armoured;
...
//     // Calculate discount
//     const { discountType, discountValue } = formData;
...
//       if (priceData.finalPrice !== formData.finalPrice) {
//         setFormData(prev => ({ 
//           ...prev, 
//           price: priceData.totalBeforeDiscount,
//           finalPrice: priceData.finalPrice 
//         }));
//       }
//     }
//   }, [formData.cableCategory, formData.subCategory, formData.cableType, 
//       formData.cableDescription, formData.cableSize, formData.quantity, 
//       formData.discountType, formData.discountValue, step]);

//   const validateClientInfo = () => {
//     const requiredFields = ['Name', 'contactPerson', 'email', 'phone', 
//                           'address', 'deliveryAddress', 'city', 'state', 'zipCode'];
...
//                   onChange={(e) => handleClientInfoChange('contactPerson', e.target.value)}
//                   className="w-full p-3 bg-gray-700 border border-gray-600 rounded-lg text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
...
//                 <label htmlFor="deliveryAddress" className="block text-sm font-medium text-blue-300 mb-2">
//                   Delivery Address *
//                 </label>
//                 <textarea
//                   id="deliveryAddress"
//                   value={clientInfo.deliveryAddress}
//                   onChange={(e) => handleClientInfoChange('deliveryAddress', e.target.value)}
...
//                   onChange={(e) => handleClientInfoChange('taxId', e.target.value)}
//                   className="w-full p-3 bg-gray-700 border border-gray-600 rounded-lg text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
...
//                   <p className="text-white font-medium">{clientInfo.contactPerson}</p>
//                 </div>
//                 <div>
...
//                   <p className="text-white font-medium">{clientInfo.deliveryAddress}</p>
//                 </div>
//               </div>
//             </div>
//           )}
...
//             {/* Cable Category */}
//             <div>
//               <label htmlFor="cableCategory" className="block text-sm font-medium text-gray-300 mb-2">
//                 Select Cable Category *
//               </label>
//               <select
//                 id="cableCategory"
//                 value={formData.cableCategory}
//                 onChange={(e) => handleCableChange('cableCategory', e.target.value)}
//                 className="w-full p-3 bg-gray-700 border border-gray-600 rounded-lg text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
//               >
...
//             {(formData.cableCategory === 'POWER CABLES' || formData.cableCategory === 'ALUMINIUM CABLES') && (
//               <div>
...
//                   onChange={(e) => handleCableChange('subCategory', e.target.value)}
//                   className="w-full p-3 bg-gray-700 border border-gray-600 rounded-lg text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
//                 >
...
//             {formData.cableCategory === 'DC Solar Flexible Photovoltic UV-Resistant Cable' && (
//               <div>
//                 <label htmlFor="solarSubCategory" className="block text-sm font-medium text-gray-300 mb-2">
//                   Cable Type *
//                 </label>
//                 <select
//                   id="solarSubCategory"
...
//                 >
//                   <option value="">Select type</option>
//                   {cableData['DC Solar Flexible Photovoltic UV-Resistant Cable'].types.map((type, index) => (
...
//             {formData.cableCategory === 'DC Solar Flexible Photovoltic UV-Resistant Cable' && formData.subCategory && (
//               <div>
//                 <label htmlFor="copperType" className="block text-sm font-medium text-gray-300 mb-2">
//                   Copper Type *
//                 </label>
//                 <select
//                   id="copperType"
//                   value={formData.cableType}
//                   onChange={(e) => handleCableChange('cableType', e.target.value)}
//                   className="w-full p-3 bg-gray-700 border border-gray-600 rounded-lg text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
//                 >
//                   <option value="">Select copper type</option>
//                   {cableData['DC Solar Flexible Photovoltic UV-Resistant Cable'].copperTypes.map((type, index) => (
//                     <option key={index} value={type}>{type}</option>
//                   ))}
//                 </select>
//               </div>
...
//             {formData.cableCategory && formData.cableCategory !== 'DC Solar Flexible Photovoltic UV-Resistant Cable' && (
//               <div className={formData.cableCategory === 'POWER CABLES' || formData.cableCategory === 'ALUMINIUM CABLES' 
//                 ? 'md:col-span-2' 
//                 : ''}>
//                 <label htmlFor="cableDescriptionOrSize" className="block text-sm font-medium text-gray-300 mb-2">
//                   {formData.cableCategory === 'POWER CABLES' || formData.cableCategory === 'ALUMINIUM CABLES' 
//                     ? 'Select Cable Size *' 
//                     : 'Select Cable *'}
//                 </label>
...
//                   value={formData.cableCategory === 'POWER CABLES' || formData.cableCategory === 'ALUMINIUM CABLES' 
//                     ? formData.cableSize 
//                     : formData.cableDescription}
//                   onChange={(e) => {
//                     if (formData.cableCategory === 'POWER CABLES' || formData.cableCategory === 'ALUMINIUM CABLES') {
...
//                       case 'Co-axial Cables(RG-Type)':
//                       case 'Telephone & Intercom Cables':
//                         return cableData[formData.cableCategory].map((item, index) => (
...
//                         const alumList = formData.subCategory === 'UN-ARMOURED CABLES' 
//                           ? alumData.unarmoured 
//                           : alumData.armoured;
...
//                         const powerList = formData.subCategory === 'UN-ARMOURED CABLES' 
...
//             {formData.cableCategory === 'DC Solar Flexible Photovoltic UV-Resistant Cable' && 
//              formData.subCategory && formData.cableType && (
//               <div>
//                 <label htmlFor="solarCableDescription" className="block text-sm font-medium text-gray-300 mb-2">
//                   Select Cable *
//                 </label>
//                 <select
//                   id="solarCableDescription"
//                   value={formData.cableDescription}
//                   onChange={(e) => handleCableChange('cableDescription', e.target.value)}
//                   className="w-full p-3 bg-gray-700 border border-gray-600 rounded-lg text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
//                 >
//                   <option value="">Select cable</option>
//                   {cableData['DC Solar Flexible Photovoltic UV-Resistant Cable'].cables.map((cable, index) => (
//                     <option key={index} value={cable.name}>{cable.name}</option>
//                   ))}
//                 </select>
//               </div>
//             )}
...
//               (formData.cableCategory === 'POWER CABLES' && formData.cableSize) ||
//               (formData.cableCategory === 'ALUMINIUM CABLES' && formData.cableSize)) && (
//               <div>
//                 <label htmlFor="coreType" className="block text-sm font-medium text-gray-300 mb-2">
//                   Select Core Type *
//                 </label>
//                 <select
//                   id="coreType"
...
//                     } else if (formData.cableCategory === 'Flexible Cables BS 6500 IEC 60228') {
//                       types = coreTypes['Flexible Cables BS 6500 IEC 60228'];
//                     } else if (formData.cableCategory === 'POWER CABLES') {
//                       types = formData.subCategory === 'ARMOURED CABLES' 
...
//                   onChange={(e) => handleCableChange('quantity', parseInt(e.target.value) || 1)}
//                   className="w-full p-3 bg-gray-700 border border-gray-600 rounded-lg text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
//                 />
...
//               {/* Discount Type */}
//               <div>
//                 <label htmlFor="discountType" className="block text-sm font-medium text-gray-300 mb-2">
//                   Discount Type
//                 </label>
//                 <select
//                   id="discountType"
...
//               {/* Discount Value */}
//               <div>
//                 <label htmlFor="discountValue" className="block text-sm font-medium text-gray-300 mb-2">
//                   Discount Value
//                 </label>
...
//             {formData.discountType === 'percentage' && formData.discountValue > 50 && (
...
//                     × {formData.quantity} {formData.cableCategory === 'POWER CABLES' || formData.cableCategory === 'ALUMINIUM CABLES' ? 'meters' : 'coils'}
//                   </span>
//                 </div>
...
//                     <div className="flex justify-between items-center">
//                       <span className="text-gray-300">
//                         Discount ({formData.discountType === 'percentage' ? `${formData.discountValue}%` : `Rs. ${formData.discountValue}`})
//                       </span>
//                       <span className="text-red-400 font-medium">
//                         - Rs. {(formData.price - formData.finalPrice).toLocaleString()}
//                       </span>
//                     </div>
...
//           <h3 className="text-lg font-semibold text-white mb-4">Quotation Information</h3>
//           <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
//             <div className="space-y-2">
//               <p className="text-gray-400">Selected Category:</p>
//               <p className="text-white font-medium">{formData.cableCategory || 'Not selected'}</p>
//             </div>
//             <div className="space-y-2">
//               <p className="text-gray-400">Selected Cable:</p>
//               <p className="text-white font-medium">{formData.cableDescription || formData.cableSize || 'Not selected'}</p>
//             </div>
//             <div className="space-y-2">
//               <p className="text-gray-400">Core Type:</p>
//               <p className="text-white font-medium">{formData.cableType || 'Not selected'}</p>
//             </div>
//             <div className="space-y-2">
//               <p className="text-gray-400">Color:</p>
//               <p className="text-white font-medium">{formData.color || 'Not selected'}</p>
//             </div>
//             <div className="space-y-2">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
          ...
          <div className="mt-6 border border-gray-600 rounded-lg p-4 bg-gray-700/30">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    type="number"
                    min="0"
                    max={formData.discountType === 'percentage' ? getDiscountLimit() : '999999'}
                    value={formData.discountValue === 0 ? '' : formData.discountValue}
                    onChange={(e) => {
                      const value = e.target.value === '' ? 0 : parseFloat(e.target.value);
                      
                      // Validate discount limit for percentage
                      if (formData.discountType === 'percentage' && value > getDiscountLimit()) {
                        alert(`Your role (${userRole}) can only apply up to ${getDiscountLimit()}% discount.`);
                        return;
                      }
                    ...
                    placeholder={formData.discountType === 'percentage' ? 
                      `Enter % (Max: ${getDiscountLimit()}%)` : 'Enter amount'}
                    disabled={formData.discountType === 'none'}
                  />
                  <span className="absolute right-3 top-3 text-gray-400">
                    {formData.discountType === 'percentage' ? '%' : 'Rs.'}
            ...
            {/* Discount warning for percentage */}
            {/* Discount warning for percentage */}
            {formData.discountType === 'percentage' && formData.discountValue > getDiscountLimit() && (
              <div className="mt-3 p-3 bg-red-500/20 border border-red-500/30 rounded-lg">
                <p className="text-red-400 text-sm flex items-center">
                  <span className="mr-2">⚠️</span>
                  Discount exceeds your limit! Maximum allowed: {getDiscountLimit()}%
                </p>
              </div>
            )}
            {formData.discountType === 'percentage' && formData.discountValue > 20 && formData.discountValue <= getDiscountLimit() && (
              <div className="mt-3 p-3 bg-yellow-500/20 border border-yellow-500/30 rounded-lg">
                <p className="text-yellow-400 text-sm flex items-center">
                  <span className="mr-2">⚠️</span>
                  High discount percentage ({formData.discountValue}%) applied
